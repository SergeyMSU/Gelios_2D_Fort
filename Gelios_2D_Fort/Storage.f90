...
module STORAGE
	...
	integer(4), parameter :: MK_k_multiply = 12! 12 * 5! 12 * 2!11 * 8!12 * 10! 12 * 7!14 * 8!6 * 3! * 6 * 9! * 6 * 8!6 * 6 * 2  !   ! 6 = 20 минут счёта (с пикапами 30 минут)
    ! 9 сейчас с пикапами
    ...
    TYPE Setka 
        ...
        real(8) :: par_nat_HP = 0.02_8   ! Поверхностное натяжение  005_8
        real(8) :: par_nat_BS = 0.003_8   ! 0.002 Поверхностное натяжение

        !! Скорость движения поверхностей
        real(8) :: par_koeff_TS = 0.1_8 ! 0.002_8 
        ...
        LOGICAL :: culc_pui = .False.   ! Считаем ли PUI ? 
